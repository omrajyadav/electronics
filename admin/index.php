...
<div class="content-wrapper" style="background: #f4f6f9; min-height: 100vh;">
  <div class="container-fluid mt-4">
    ...
    <div class="row g-4 mb-5">
      <div class="col-md-3">
        <div class="card dashboard-card shadow-sm border-0 bg-primary text-white h-100">
      ...
      <div class="col-md-3">
        <div class="card dashboard-card shadow-sm border-0 bg-success text-white h-100">
          <div class="card-body d-flex align-items-center">
      ...
      <div class="col-md-3">
        <div class="card dashboard-card shadow-sm border-0 bg-warning text-white h-100">
          <div class="card-body d-flex align-items-center">
      ...
      <div class="col-md-3">
        <div class="card dashboard-card shadow-sm border-0 bg-info text-white h-100">
          <div class="card-body d-flex align-items-center">
